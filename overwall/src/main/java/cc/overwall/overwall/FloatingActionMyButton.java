...
//mport cc.overwall.overwall.R;


public class FloatingActionMyButton extends MyButton {
    ...
    public FloatingActionMyButton(Context context, AttributeSet attributes) {
